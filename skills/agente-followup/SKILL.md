# agente-followup — Proactive Outreach & Follow-ups
...
- Appointment reminder needs to be sent (coordinates with agente-appointments)
...
- **Appointment Reminders** — Pre-appointment notifications (coordinates with agente-appointments)
...
[If negative response → trigger agente-escalation]
```
