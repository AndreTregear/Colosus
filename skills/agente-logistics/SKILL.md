# agente-logistics — Shipping, Courier Integration & Delivery Management
...
- **Refund coordination** — Links to agente-payments for refund processing when return is confirmed
...
### Shipping Cost Tracking (integrates agente-expenses)
- **Auto-log shipping expenses** — Every shipment cost is automatically logged to agente-expenses under 🚛 Transporte category
...
- `LOGISTICS_AUTO_EXPENSE_LOG` — Auto-log shipping costs to agente-expenses (default: true)
