# yaya-pharmacy — Pharmacy Operations, Drug Safety & DIGEMID Compliance
...
Yaya: "🔴 INTERACCIÓN GRAVE: Warfarina + Ibuprofeno
...
Yaya: "✅ Temperatura registrada: 4.2°C (8:00 AM)
...
Yaya: "✅ Registrado: S/450 — EPS Pacífico
...
Extends yaya-inventory with pharmacy-specific fields:
...
Yaya: "📦 Productos próximos a vencer (siguiente 90 días):
...
Yaya: "🚨 ALERTA DE RETIRO DE PRODUCTO
  💊 Ibuprofeno 400mg
  🔢 Lote: X2025-033
...
Yaya: "📊 Análisis competitivo — Atorvastatina 20mg:
...
Yaya: "🤒 Preparación temporada gripe (May-Ago):
...
|-----------|-------------|
| yaya-inventory | Extends with lot numbers, expiry dates, storage conditions, regulatory category |
| yaya-expenses | Purchase costs from distributors (Química Suiza, DECO, Alfaro) tracked as expenses |
| yaya-suppliers | Distributor relationships, PO creation, lab rep visit scheduling |
| yaya-crm | Patient records (chronic conditions, insurance provider, medication history) |
| whatsapp-mcp | EPS claim follow-ups, expiry promotions to frequent customers, recall notifications |
| yaya-analytics | Margin analysis by product category (genérico vs marca vs dermocosmética) |
| yaya-tax | SUNAT compliance for pharmacy (some products exento de IGV: medicamentos esenciales) |
| yaya-fiados | Track customer credit (common for chronic medication patients who pay monthly) |
| yaya-cash | Cash vs insurance vs Yape reconciliation |
| yaya-forecast | Seasonal illness demand prediction, reorder point calculation |
| yaya-escalation | Drug safety alerts, adverse reaction reporting, DIGEMID recall handling |
...
Yaya: "🟡 INTERACCIÓN MODERADA: Enalapril + Ibuprofeno
...
Yaya: "✅ Registrado: 6.8°C a las 8:15 AM
...
Yaya: "📊 Cuentas por cobrar — Seguros:
🏥 EPS Pacífico:
...
Yaya: "📋 Checklist DIGEMID — Preparación:
...
- Key scenario improvements:
  ...
  - Net profitability (S21): 8.7 → maintain (already strong from yaya-expenses)
