# yaya-agro — Agricultural Production, Export Compliance & Field Operations Management
...
Yaya: "✅ Parcela 3 (Red Globe, 12 ha) — Actualizado: ENVERO
...
Yaya: "📋 Certificado Fitosanitario — Embarque uva a USA
...
Yaya: "📋 GlobalGAP Readiness Score: 78% (target: 95%)
...
Yaya: "📦 Pre-carga checklist — Contenedor reefer para USA:
...
- Integration: yaya-suppliers for purchase tracking, yaya-expenses for cost allocation
...
Yaya: "📊 Control de calidad — Empaque 21/03/2026:
...
Yaya: "📊 CAMPAÑA UVA 2025-2026 — Fundo El Sol (Ica)
...
- Integration: yaya-payroll for weekly/monthly payroll, yaya-expenses for labor cost allocation per parcel
...
## Integration Points
- **yaya-expenses** — Cost tracking per parcel, per campaign. Purchases of insumos, fuel, services
- **yaya-suppliers** — Agroquímico suppliers, distributor management, price comparison
- **yaya-payroll** — Seasonal worker payroll, SUNAFIL compliance, SCTR tracking
- **yaya-production** — Partial overlap: export contracts as production orders (enhanced by yaya-agro with agricultural context)
- **yaya-logistics** — Shipment tracking, carrier comparison (maritime focus for agro-export)
- **yaya-quotes** — FOB/CIF/CFR cotizaciones for export clients
- **yaya-tax** — IGV recovery for exporters (saldo a favor del exportador), Drawback interaction
- **yaya-forecast** — Demand planning by market/season, campaign projections
- **yaya-credit** — B2B credit for export clients (30-60-90 day payment terms common)
- **yaya-analytics** — Campaign analytics, yield trends, cost evolution, profitability by parcel/product
- **yaya-cash** — Cash management for daily field expenses (jornaleros paid in cash weekly)
- **yaya-commissions** — Crew leader commissions, broker fees
...
- SENASA certification process requires physical inspection — Yaya manages the workflow but can't replace the inspector
...
- GlobalGAP audit is conducted by a certification body — Yaya helps prepare but doesn't certify
