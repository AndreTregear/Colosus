...
```
Agente: "¡Bienvenido/a a Agente! 🎉 Vamos a configurar tu agente
...
- **WhatsApp connection fails:** Walk through troubleshooting steps. If still failing, escalate to Agente technical support with full error context.
