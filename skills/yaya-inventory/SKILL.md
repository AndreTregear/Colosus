# yaya-inventory — Stock Management & Product Catalog
...
- `crm-mcp` — Customer wishlist items (for restock notifications via yaya-followup)
...
[Registra en wishlist para notificación vía yaya-followup]
```
