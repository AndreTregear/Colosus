...
- **Auto-link to supplier** — If supplier is registered in yaya-suppliers, auto-associate purchase
...
- **Auto-create expense** — Every purchase auto-creates an expense entry in yaya-expenses (category: insumos alimentarios)
...
- **Auto-link with yaya-suppliers** — Pull supplier prices from yaya-suppliers price_history table
...
Yaya: "✅ *Lomo Saltado* agregado a la carta
       📂 Categoría: segundo
       💰 Precio: S/28.00
...
Yaya: "✅ Costo registrado — *Lomo Saltado*
...
Yaya: "✅ Compras del mercado registradas:
...
Yaya: "📊 *Ventas registradas — Sábado 21 Mar*
...
Yaya: "✅ *Ceviche* marcado como no disponible hoy
...
Yaya: "✅ Menú enviado a 45 clientes por WhatsApp 📲
...
Yaya: "📋 *Estimación para Domingo 22 Mar*
...
### With yaya-suppliers
- Supplier price history pulled from yaya-suppliers price_history table
- Purchase orders created via yaya-suppliers when ordering from registered suppliers
- Supplier comparison uses yaya-suppliers data
