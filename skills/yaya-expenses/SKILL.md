...
- **Daily P&L Calculation** — Revenue (from yaya-analytics) minus expenses = profit, updated in real time
...
- **Unified P&L Reports** — Pull revenue from yaya-analytics, combine with expenses for complete financial picture
...
- **IGV Tracking** — Track IGV paid on purchases as crédito fiscal (coordinates with yaya-tax)
...
Agente: [consulta postgres + erpnext via yaya-analytics]
