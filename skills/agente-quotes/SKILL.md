# agente-quotes — B2B Quotation / Cotización Generator
...
The skill bridges the gap between sales inquiry (agente-sales handles customer chat) and order management (agente-suppliers handles purchasing) by managing the outbound pricing step: what does the customer want, at what price, and did they accept?
...
Agente: [looks up Juan Pérez in crm-mcp → finds Constructora JP]
Agente: [creates quote with line items, calculates IGV]
Agente: "📋 *Cotización #COT-2026-015*
       👤 Juan Pérez — Constructora JP
...
Owner: "Sí, mándale"
Agente: [sends via whatsapp-mcp]
Agente: "✅ Cotización #COT-2026-015 enviada a Juan (987 654 321) 📲
...
Agente: [transcribes voice → looks up "maestro Carlos" in crm-mcp]
Agente: [looks up products in erpnext-mcp → finds prices]
Agente: [applies volume pricing tiers for 50 bolsas]
Agente: "📋 *Cotización #COT-2026-016*
...
Agente: "⏰ Han pasado 3 días y Carlos no respondió a COT-2026-016 (S/2,950).
       ¿Le mando un recordatorio? 📲"
Owner: "Sí, mándale"
Agente: [sends via whatsapp-mcp]
Agente: "📲 Recordatorio enviado:
...
Agente: "✅ Cotización #COT-2026-016 — aceptación parcial
...
Agente: "📊 *Comparación de precios — Cemento Pacasmayo*
...
Agente: [looks up last quote to Juan → COT-2026-015]
Agente: "📋 *Cotización #COT-2026-015 v2* (revisada)
       👤 Juan Pérez — Constructora JP
...
Agente: [fetches today's exchange rate from forex-mcp: 1 USD = S/3.72]
Agente: "📋 *Cotización #COT-2026-022*
       👤 Import Solutions SAC
...
- "¿A cuánto el cemento?" → agente-sales handles conversation, agente-quotes generates formal cotización if needed
...
### With agente-tax / invoicing-mcp
- IGV calculation follows agente-tax rules (18% for Peru)
...
### With agente-followup
- Quote follow-up reminders integrate with general follow-up system
- Avoid duplicating reminders if agente-followup already has a pending task for the same customer
