# agente-credit — B2B Accounts Receivable & Cartera Management
...
- **Limit check on sale** — When agente-sales processes a credit sale, check: current outstanding + new sale ≤ credit limit. If exceeded: "⚠️ Constructora Pérez tiene S/4,500 pendiente. Nuevo pedido de S/2,000 excede su límite de S/5,000. ¿Aprobar de todas formas?"
...
- **Invoice from agente-sales** — When a sale is closed with payment_method='crédito', auto-create receivable invoice
...
- **Sales integration** — When agente-sales processes a sale to a blocked customer: "⚠️ Empresa X tiene crédito bloqueado (deuda vencida: S/8,500). Solo venta al contado."
...
#### agente-sales Integration
- **Credit check on sale** — Before completing a credit sale, agente-sales calls agente-credit to verify:
...
- **Auto-invoice creation** — When agente-sales closes a credit sale, auto-create receivable in agente-credit
- **Credit status in customer profile** — Sales team can see credit status when interacting with customer

#### agente-analytics Integration
- **Cash flow projections** — Feed receivables data into agente-analytics for cash flow forecasting
...
#### agente-fiados Bridge
- **Formalization path** — When a fiado customer grows into a B2B relationship: "Doña Carmen ahora tiene RUC y quiere crédito formal" → migrate from agente-fiados to agente-credit
- **Clear separation** — agente-fiados = informal B2C tabs (S/5-200, neighborhood trust). agente-credit = formal B2B receivables (S/500-50,000+, invoiced, terms-based)

#### agente-expenses Integration
...
#### agente-ledger Integration
- **Credit sales in daily ledger** — Credit sales logged in agente-ledger as sale type 'crédito' (revenue recognized at sale, not collection)
...
Agente:  "✅ Actualizado. Constructora Pérez está listo para compras a crédito."
```
...
Agente:  "✅ Factura F-0052 creada. Constructora Pérez ahora tiene
...
Agente:  "💰 Pago recibido: S/5,000 de Constructora Pérez
...
Agente:  "✅ Pago de S/5,000 registrado (depósito).
...
Agente:  "📊 Resumen de Cartera — 21 Mar 2026
...
Agente:  "📋 Ing. García tiene S/8,200 vencido (62 días):
...
Agente:  "✅ Cobro enviado a Ing. García (WhatsApp: 987654321).
...
Agente:  "📊 Evaluación Crediticia — Constructora Pérez
...
Agente:  "⚠️ Empresa Torres — Situación actual:
...
Agente:  "✅ Crédito bloqueado para Empresa Torres.
...
Agente:  "🏦 Reconciliación de depósitos:
...
Agente:  "📊 Mora de Ing. García (tasa: 2% mensual)
...
Agente:  "💸 Proyección de cobros — Marzo 2026
...
## Differences from agente-fiados

| Aspect | agente-fiados | agente-credit |
|--------|-------------|-------------|
