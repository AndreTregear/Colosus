# agente-tax-colombia — Colombian Tax Compliance & Electronic Invoicing (DIAN)
...
- **Expense Deductibility** — Cross-reference with agente-expenses to identify deductible expenses for renta
...
- ⚠️ agente-tax-colombia provides deadline reminders ONLY — does NOT calculate contributions
...
Agent: [consulta agente-expenses vía erpnext-mcp/postgres-mcp]
