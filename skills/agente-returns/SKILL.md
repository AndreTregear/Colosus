# agente-returns — Returns, Refunds & Exchanges
...
- Post-purchase satisfaction check (via agente-followup) reveals a product issue
...
[Escalación automática al dueño via agente-escalation]
```
...
- **Customer becomes frustrated:** If tone escalates, trigger agente-escalation for human handoff. Don't argue about policy.
