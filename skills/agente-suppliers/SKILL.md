# agente-suppliers — Supplier & Purchase Order Management
...
The skill bridges the gap between expense tracking (agente-expenses records the spend) and inventory (what's in stock) by managing what happens in between: who do I buy from, what do I order, when does it arrive, and am I getting a good price?
...
- **Auto-expense creation** — Delivered PO automatically creates expense in agente-expenses (category: inventario/materiales)
...
- **Price alerts** — "El pollo subió de S/15 a S/18" → proactive alert with margin impact (integrates with agente-expenses COGS)
...
Agente: "✅ Productos de Juan Pérez:
...
Agente: "📦 *Pedido para Gloria Distribuciones*
...
Owner: "Sí, mándale"
Agente: "✅ Pedido #PO-2026-043 enviado a Gloria por WhatsApp 📲
...
Agente: "📦 Recibiendo pedido #PO-2026-043 de Gloria...
...
Agente: "📲 Le mandé mensaje a Gloria:
...
Agente: "📊 *Comparación: Arroz Extra (saco 50kg)*
...
Agente: "🛒 *Lista para el mercado — sábado 22 mar*
